...
$phone = $_POST['phone'];
$desc = $_POST['desc'];
$sql = "INSERT INTO `trip`.`trip`(`name`, `age`, `gender`, `email`, `phone`, `desc`, `dr`)VALUES('$name', 
'$age','$gender', '$email', '$phone', '$desc', current_timestamp());";
//echo $sql;

// Execute the query
if($con->query($sql) == true){
    //echo "sucessfully inerted";
...
<body>
    <img class="bg" src="bgg.jpg" alt="bkc">
    <div class="container">
    <h1>Welcome to Balkumari college Canada trip form</h1>
    <p>Enter yours details to comfrim the partcipation of trip</p>
    <?php
    if($insert == true){
